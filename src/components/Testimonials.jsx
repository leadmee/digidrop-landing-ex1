...
const reviews = [
  {
    initials: 'АК',
    name: 'Анна Ковалёва',
    role: 'Продаёт курсы по графическому дизайну',
    text: 'До DigiDrop я вручную отправляла архив каждому из ~200 учеников в месяц и по вечерам разбирала письма «мне ничего не пришло». Перенесла три курса за один вечер, вставила ссылку в Instagram — и за полгода 1 400 продаж прошли без единой ручной отправки. Освободившееся время трачу на новый курс, а не на техподдержку.',
    offset: 'md:mt-0',
  },
  {
    initials: 'МШ',
    name: 'Марк Штайнер',
    role: 'Разработчик плагинов для WordPress',
    text: 'Продаю два премиум-плагина и жил в страхе, что купленную сборку выложат на nulled-сайтах. Теперь каждому покупателю уходит персональный лицензионный ключ, привязанный к домену, а обновления — по защищённой ссылке с лимитом. Один ключ по ошибке продал дважды в Excel — с автогенерацией это в принципе невозможно.',
    offset: 'md:mt-12',
  },
  {
    initials: 'ДЧ',
    ...
    text: 'Мои паки утекали на форумы буквально через день после релиза — прямую ссылку на Google Drive пересылали кому попало. Ссылки с водяным знаком по e-mail покупателя и лимитом скачиваний закрыли этот канал: за три месяца ни одной утечки, а средний чек вырос на 18% после того, как я добавил лицензию для коммерческого использования.',
    offset: 'md:mt-4',
  },
]
